...
export default function Showcase() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Badget - Heading */}
      <div className="w-full flex flex-col items-center p-6 md:py-4 md:px-12 lg:px-[80px] mx-auto mt-24 mb-8">
        ...
        {/* Main Heading */}
        <h1 className="w-[768px] text-primary-black text-center font-rethinkSans text-[56px] font-bold leading-[64px] tracking-[0.56px] font-feature-settings-salt not-italic">
          See Mues AI in action <br /> on your favorite softwares
        </h1>
      </div>
      ...
      <div className="w-full h-[374px] mb-37 flex relative">
        ...
        <div className='flex flex-col items-center absolute left-1/2 top-6 -translate-x-1/2 '>
          ...
          <div className="w-fit flex items-center justify-center gap-4 mt-12 ">
        ...
        {/* Play Animation-Video Buttons */}
        <div className="w-fit flex items-center justify-center gap-4 mt-8 absolute bottom-0 left-1/2 -translate-x-1/2 hidden">
