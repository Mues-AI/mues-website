...
// {/* YAP - TO DO : fotoğraflar düzenlenecek */}
    ...
    <div className='min-h-screen'>
      ...
      <div className="relative w-full aspect-video hidden lg:block">
        ...
        <div className="w-full h-full flex flex-col justify-between gap-20 xl:gap-[119px] p-12 2xl:p-20">
          ...
          {/* BADGE */}
          <div className="w-fit inline-flex px-[12px] py-[8px] justify-center items-center gap-[6px] rounded-[12px] border border-[rgba(255,255,255,0.25)] mt-6">
          ...
          <div className="w-full h-full relative">
            ...
            {/* 1. line */}
            <div className='inline-flex flex-col items-center gap-1 xl:gap-2 absolute bottom-[46%] xl:bottom-[42%] left-[17.66%]'>
            ...
            {/* 2. line */}
            <div className='inline-flex flex-col items-center gap-1 xl:gap-2 absolute bottom-[58%] xl:bottom-[53%] left-[36%]'>
              <div className="inline-flex justify-center items-center mb-1 w-6 h-6 rounded-[8px] bg-[rgba(255,255,255,0.08)] shadow-[0px_1px_4px_0px_rgba(34,34,34,0.05)]">
            ...
            {/* 3. line */}
            <div className='inline-flex flex-col items-center gap-1 xl:gap-2 absolute top-[40%] xl:top-[42%] left-[84%]'>
